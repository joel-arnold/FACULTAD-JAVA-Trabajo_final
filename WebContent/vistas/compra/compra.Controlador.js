window.onload = function() {
    ...
    let enlaceTodas = document.getElementById('catTodas')
    let enlacePerros = document.getElementById('catPerros')
    let enlaceGatos = document.getElementById('catGatos')
    let enlaceAves = document.getElementById('catAves')
    let enlacePipetas = document.getElementById('catPipetas')
    enlaceTodas.classList.add('font-weight-bold')
    ...
    enlaceTodas.addEventListener('click', () => {
        categoriaElegida = ""
        enlaceTodas.classList.add('font-weight-bold')
        enlaceGatos.classList.remove('font-weight-bold')
        enlacePerros.classList.remove('font-weight-bold')
        enlaceAves.classList.remove('font-weight-bold')
        enlacePipetas.classList.remove('font-weight-bold')
        items.innerHTML = ""
        renderizarProductos()
    })

    enlaceGatos.addEventListener('click', () => {
        categoriaElegida = "Alimento para gatos"
        enlaceTodas.classList.remove('font-weight-bold')
        enlaceGatos.classList.add('font-weight-bold')
        enlacePerros.classList.remove('font-weight-bold')
        enlaceAves.classList.remove('font-weight-bold')
        enlacePipetas.classList.remove('font-weight-bold')
        items.innerHTML = ""
    ...
    document.getElementById('catPerros').addEventListener('click', () => {
        ...
        enlaceTodas.classList.remove('font-weight-bold')
        enlaceGatos.classList.remove('font-weight-bold')
        enlacePerros.classList.add('font-weight-bold')
        enlaceAves.classList.remove('font-weight-bold')
        enlacePipetas.classList.remove('font-weight-bold')
        items.innerHTML = ""
        renderizarProductos()
    ...
    document.getElementById('catAves').addEventListener('click', () => {
        ...
        enlaceGatos.classList.remove('font-weight-bold')
        enlacePerros.classList.remove('font-weight-bold')
        enlaceAves.classList.add('font-weight-bold')
        enlacePipetas.classList.remove('font-weight-bold')
        items.innerHTML = ""
        renderizarProductos()
    })
    ...
    document.getElementById('catPipetas').addEventListener('click', () => {
        ...
        enlacePerros.classList.remove('font-weight-bold')
        enlaceAves.classList.remove('font-weight-bold')
        enlacePipetas.classList.add('font-weight-bold')
        items.innerHTML = ""
        renderizarProductos()
    })
