...
<html lang="en">
  <head>
    ...
    <title>Categorias de Producto</title>
    <script type="text/javascript" src="vistas/administracion/categoriasProducto.Controlador.js"></script>
  </head>
  ...
  <body class="bg-light">
    ...
    <jsp:include page="vistas/administracion/categoriasProducto.jsp"></jsp:include>
    <% } else{ 
